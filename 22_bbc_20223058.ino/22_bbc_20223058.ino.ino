...
// Servo adjustment
#define _DUTY_MAX 2423  // Servo angle: D degree
#define _DUTY_NEU 1416  // Servo angle: 0 degree
#define _DUTY_MIN 531   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 478 + -1.51*a_value + 1.2E-03*a_value*a_value;
}
